...
// Query data pasien
$cv = query("SELECT * from covid WHERE id = $id")[0];
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label for="tanggal_cvd" class="form-label font-weight-bold">Tanggal Periksa</label>
                                <input type="text" name="tanggal_cvd" id="tanggal_cvd" class="form-control bg-light text-center" value="<?= $cv["tanggal_cvd"]; ?>" readonly>   
                            </div>
