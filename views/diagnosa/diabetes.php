...
if (isset($_POST["submit"]) ) {
    ...
    if ( act_diabetes($_POST) > 0 ) {
        echo "
            <script>
                alert('Data berhasil diinputkan!');
                document.location.href = '?page=pasien_diabetes';
            </script>
        ";
    } else {
        echo "
            <script>
                ...
                document.location.href = '?page=diabetes';
            </script>
        ";
    }
}
...
<div class="content-header row px-5">
    <div class="content-header-left mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left">Gula Darah (Diabetes Tipe 1)</h2>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="card mb-5">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="input-group input-group-outline mb-3">
                                    <label class="form-label" for="tanggal_gd"></label>
                                    <input type="date" name="tanggal_gd" id="tanggal_gd" class="form-control" required>
                                </div>
                        ...
                        <ol style="margin-left: 25px">
                            ...
                            <li style="line-height: 2; font-size: 16px;">
                                Sering merasa lapar sehingga banyak makan (polifagia), tetapi berat badan menurun ?
                                <ul class="list-unstyled mb-0">
                                    <li class="d-inline-block" style="padding-right:2em">
                                        <fieldset>
                                            <div class="vs-radio-con vs-radio-warning">
                            ...
                            <li style="line-height: 2; font-size: 16px;">
                                Sering mengalami infeksi di kulit, vagina, atau saluran kemih ?
                                <ul class="list-unstyled mb-0">
                                    <li class="d-inline-block" style="padding-right:2em">
                                        <fieldset>
                                            <div class="vs-radio-con vs-radio-warning">
