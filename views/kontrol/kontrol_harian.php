            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Daftar Kontrol Harian Pasien</h6>
                    </div>
                </div>
                    ...
                    <div class="table-responsive p-0">
                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <?php
                                $no = 1;
                                $tampil_harian = $psn->tampil_harian();
                                while($data = $tampil_harian->fetch_object()) {
                                ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex px-2 py-1 text-center ">
                                            <div class="d-flex flex-column justify-content-center">
                                                <span class=" mb-0"><?php echo $data->keluhan;?></span>
                                            </div>
                                        </div>
                                    </td>

                                    <td class="text-center">
                                        <a href="?page=cek_harian&id=<?php echo $data->id; ?>">
