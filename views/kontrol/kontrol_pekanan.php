            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Daftar Kontrol Harian Pekanan</h6>
                    </div>
                </div>
                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Tanggal Check Up</th>
                            ...
                            <tbody>
                                ...
                                <?php
                                $no = 1;
                                $tampil_pekanan = $psn->tampil_pekanan();
                                while($data = $tampil_pekanan->fetch_object()) {
                                ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex px-2 py-1 text-center ">
                                            <div class="d-flex flex-column justify-content-center">
                                                <span class=" mb-0"><?php echo $data->catatan;?></span>
                                            </div>
                                        </div>
                                    </td>

                                    <td class="text-center">
                                        <a href="?page=cek_pekanan&id=<?php echo $data->id; ?>">
